#!/usr/bin/env python3
"""
Evaluate Simple Ultra-Advanced Bounce Detector

Quick evaluation of the simple detector with different thresholds.
"""
...
from simple_ultra_detector import SimpleUltraDetector

logging.basicConfig(level=logging.INFO, format='%(levelname)s:%(name)s:%(message)s')
logger = logging.getLogger(__name__)


def evaluate_simple_detector():
    """Evaluate simple detector with different thresholds"""
    ...
    for threshold in thresholds:
        ...
        detector = SimpleUltraDetector(threshold=threshold)
